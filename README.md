...
Если вы будете особо внимательны, то заметите, что даже те редкие комментарии в коде, написаны на английском. И нет, это не потому что я бездумно пользовался копайлотом, копировал чужой или сгенерированный ИИ, код. Всё гораздо проще - это помогает мне практиковать английский язык и пополнять мой словарный запас. Описание к коммитам я тоже делаю на английском, по тем же причинам.
## Использование нейросетей
Продолжая тему с ИИ из предыдущего раздела. Значит ли это, что я вообще не пользуюсь нейросетями? Нет. Довольно часто я спрашиваю про нейминг переменных и полей, прошу предложить варианты удачных архитектурных решений, задать направление моих дальнейших размышлений, прошу копайлот исправить мой затуп. Но никогда, предложенный код, бездумно не копирую, особенно, если там что-то новое и непонятное для меня. Пока я не разберусь, как это работает, в мой проект это не попадёт. Другими словами - вайбкодингом я не занимаюсь.
